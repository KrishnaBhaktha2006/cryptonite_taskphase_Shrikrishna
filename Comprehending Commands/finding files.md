...
/opt/linux/linux-5.4/arch/x86/events/flag
...
tags.r2
hacker@commands~finding-files:/usr/local/share/radare2/5.9.5/flag$ cd /opt/linux/linux-5.4/arch/x86/events/flag
ssh-entrypoint: cd: /opt/linux/linux-5.4/arch/x86/events/flag: Not a directory
hacker@commands~finding-files:/usr/local/share/radare2/5.9.5/flag$ cat /opt/linux/linux-5.4/arch/x86/events/flag
pwn.college{0Qwd9jsk-FfMupSV5tPmP9xRKUI.dJzM4QDL0kTN0czW}
```
## Learnings:
got it after reading the question second time!
## References:
